...
// run
List run(unsigned& N, unsigned& d, unsigned& timeSteps, Eigen::MatrixXd Y, Eigen::VectorXd m0, Eigen::MatrixXd C0, Eigen::MatrixXd F, Eigen::MatrixXd G, Eigen::MatrixXd V, Eigen::MatrixXd W, float df, std::string resampler, std::string distribution, unsigned p);
RcppExport SEXP _CuSMC_run(SEXP NSEXP, SEXP dSEXP, SEXP timeStepsSEXP, SEXP YSEXP, SEXP m0SEXP, SEXP C0SEXP, SEXP FSEXP, SEXP GSEXP, SEXP VSEXP, SEXP WSEXP, SEXP dfSEXP, SEXP resamplerSEXP, SEXP distributionSEXP, SEXP pSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(run(N, d, timeSteps, Y, m0, C0, F, G, V, W, df, resampler, distribution, p));
    return rcpp_result_gen;
END_RCPP
}
// metropolis_hastings
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_CuSMC_run", (DL_FUNC) &_CuSMC_run, 14},
